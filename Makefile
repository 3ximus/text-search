...
merge: matcher.c dynamic_array.h algorithms/naive_search.h algorithms/Boyer-Moore.h algorithms/KMP.h
	...
	grep -h '#define [^_]' matcher.c dynamic_array.h algorithms/* -d recurse >> merged_project.c;
	cat dynamic_array.h algorithms/* matcher.c | grep -v '#include\|#endif\|#ifndef\|#define' >> merged_project.c;
